...
con=sqlcon.connect(host="localhost",user="root",passwd="sanika")#connection to mysql 
cur=con.cursor()
...
def register():
    ...
    label=Label(root1,text="REGISTER YOURSELF",font='arial 25 bold underline',bg='light blue')
    label.pack()
    frame=Frame(root1,height=500,width=200,bg='light blue')
    frame.pack()
    l1=Label(root1,text="AADHAR CARD NO.",bg='light blue')
    l1.place(x=10,y=130)
    e1=tkinter.Entry(root1)
    e1.place(x=100,y=130)
    l2=Label(root1,text="NAME",bg='light blue')
    l2.place(x=10,y=170)
    e2=tkinter.Entry(root1)
    e2.place(x=100,y=170)
    l3=Label(root1,text="AGE",bg='light blue')
    l3.place(x=10,y=210)
    e3=tkinter.Entry(root1)
    e3.place(x=100,y=210)
    l4=Label(root1,text="GENDER M\F",bg='light blue')
    l4.place(x=10,y=250)
    e4=tkinter.Entry(root1)
    e4.place(x=100,y=250)
    l5=Label(root1,text="PHONE",bg='light blue')
    l5.place(x=10,y=290)
    e5=tkinter.Entry(root1)
    e5.place(x=100,y=290)
    l6=Label(root1,text="BLOOD GROUP",bg='light blue')
    l6.place(x=10,y=330)
    e6=tkinter.Entry(root1)
    e6.place(x=100,y=330)
    b1=Button(root1,text="SUBMIT",command=entry,bg='light blue')
...
label=Label(root,text="MD CITY HOSPITAL MANAGEMENT SYSTEM",font="arial 40 bold underline",bg='pink')
b1=Button(text="Registration",font="arial 20 bold",bg='pink',command=register)
b2=Button(text="Appointment",font="arial 20 bold",bg='pink',command=apoint)
b3=Button(text="List of Doctors",font="arial 20 bold",bg='pink',command=lst_doc)
b4=Button(text="Services available",font='arial 20 bold',bg='pink',command=ser_avail)
b7=Button(text="View data",font='arial 20 bold',bg='pink',command=search_data)
b5=Button(text="Modify existing data",font='arial 20 bold',bg='pink',command=mod_sub)
...
b5.place(x=10,y=410)
b6.place(x=10,y=550)
frame=Frame(root,height=600,width=50,bg='light blue')
frame.pack()
root.resizable(False,False)
root.mainloop()
